// OpenAI API — Node.js built-in fetch use ho raha hai (Node 18+)
...
export const aiChat = async (req, res) => {
    ...
    if (!apiKey) {
        return res.status(500).json({ message: "AI not configured. Add OPENAI_API_KEY to backend .env on Render." });
    }
